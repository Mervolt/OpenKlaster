...
import com.openklaster.core.authentication.SuccessfulSessionAuthentication;
import com.openklaster.core.repository.CrudRepository;
import com.openklaster.core.properties.CoreErrorMessages;
...
public class LoginManager implements UserManager {
    ...
    private void handleFailure(String reason, Message<JsonObject> message) {
        logger.error(String.format(failedMessage, reason), reason);
