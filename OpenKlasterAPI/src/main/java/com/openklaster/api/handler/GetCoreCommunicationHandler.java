...
public class GetCoreCommunicationHandler extends CoreCommunicationHandler {
    public GetCoreCommunicationHandler(String route, String address, IParseStrategy<? extends Model> parseStrategy) {
        super(HandlerProperties.getMethodHeader, route, HandlerProperties.getMethodHeader, address, parseStrategy);
    }

    public GetCoreCommunicationHandler(String route, String address, String eventbusMethod, IParseStrategy<? extends Model> parseStrategy) {
