...
public class DeleteHandler extends Handler {
    public DeleteHandler(String route, String address, IParseStrategy<? extends Model> parseStrategy) {
        super(HandlerProperties.deleteMethodHeader, route, HandlerProperties.deleteMethodHeader, address, parseStrategy);
    }

    public DeleteHandler(String route, String address, String eventbusMethod, IParseStrategy<? extends Model> parseStrategy) {
